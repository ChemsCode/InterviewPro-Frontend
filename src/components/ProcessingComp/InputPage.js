    ...
    <>
      ...
      <div className="w-full bg-white py-16 px-4">
        <form className="max-w-[1000px] mt-[0px] mx-auto text-center flex flex-col justify-center">
          ...
          <h2 className="text-4xl font-bold text-center py-6">interviewPro.</h2>
          <div className="flex flex-col justify-center">
            ...
            question in the text box below, then type or paste your answer into
            the provided text box. Click the "Submit" button to submit your
            answer for analysis, which will give you feedback on what you did
            wrong and what to improve. Review the feedback and tips provided,
            and repeat the process as many times as you like to continue
